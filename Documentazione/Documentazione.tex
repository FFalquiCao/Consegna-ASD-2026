...
Invece, il modo efficiente di risolvere questo problema è con un hash, implementato in \texttt{C++} con la struttura dati \texttt{unordered_map}. Siccome questa struttura dati non ammette comodamente l'uso di pair come chiavi, creo un vettore di mappe le cui \textit{keys} sono il secondo elemento della coppia e i \textit{values} sono i valori degli archi.
